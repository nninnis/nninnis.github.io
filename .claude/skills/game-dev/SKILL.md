---
name: game-dev
description: "HTML5 게임 프로토타입을 제작하고 games/ 디렉토리에 추가한다. 새 게임 만들기, 게임 아이디어 구현, HTML5 게임 추가, 플레이어블 프로토타입 제작 요청 시 반드시 이 스킬을 사용하라. 기존 게임 수정·개선·재구현, 다시 만들기, 게임 업데이트 요청에도 반드시 트리거."
---
